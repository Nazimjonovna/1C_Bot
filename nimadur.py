...
# Token of tg_Bot
API_TOKENS = [
    os.getenv("6294303719:AAHsrz67cA8AXC4FO4A-ubxctwZE5syW4o0"),
    os.getenv("6270510331:AAEt5t__W6Q7s3sswc9A_6bJIqRvSoALtIM"),
...
bots = [Bot(token=token) for token in API_TOKENS]
dispatchers = [Dispatcher(bot, storage=storage) for bot in bots]
...
for i, dp in enumerate(dispatchers, start=1):
